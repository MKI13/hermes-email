...
Version `0.5.0` does not implement production message retrieval or sending. Never commit credentials, tokens, passwords, private keys, real messages, or account-specific configuration. Treat third-party plugins and future provider adapters as trusted code running with the user's permissions.
