...
_ALLOWED_OPERATIONS={"list","get","search","thread","draft-create","draft-reply-create","draft-reply-all-create","draft-list","draft-get","draft-update","draft-trash","draft-restore","draft-send-review","health"}
