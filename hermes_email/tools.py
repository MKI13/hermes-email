...
def _message_detail(
    ...
    return {
        ...
        **_message_location(message),
        ...
        "cc": [_address_result(a) for a in message.cc[:_MAX_TOOL_RECIPIENTS]],
        "cc_truncated": len(message.cc) > _MAX_TOOL_RECIPIENTS,
        "recipient_headers_invalid": message.recipient_headers_invalid,
        "reply_to_present": message.reply_to_present or bool(message.reply_to),
        "reply_to_invalid": message.reply_to_invalid,
