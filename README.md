...
Version 0.32.0 adds a **redacted provider health tool**. `email_provider_health` performs one explicit provider health probe without reading mailbox content and returns only fixed provider/state/diagnostic/readiness fields.
